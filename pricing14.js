        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <fragment>
                  <span className="pricing14-text104 thq-heading-2">
                    Pricing plan
                  </span>
                </fragment>
              )}
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <fragment>
                        <span className="pricing14-text085 thq-heading-3">
                          $99/month
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  <p>
                    {props.plan2 ?? (
                      <fragment>
                        <span className="pricing14-text097 thq-body-large">
                          Standard Plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <fragment>
                        <span className="pricing14-text083 thq-heading-3">
                          $199/month
                        </span>
                      </fragment>
                    )}
                  ...
                  <p>
                    {props.plan2Yearly ?? (
                      <fragment>
                        <span className="pricing14-text064 thq-body-large">
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  <span>
                    {props.plan11 ?? (
                      <fragment>
                        <span className="pricing14-text058 thq-body-large">
                          Basic plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <fragment>
                        <span className="pricing14-text063 thq-heading-3">
                          $999/year
                        </span>
                      </fragment>
                    )}
                  ...
                  <span>
                    {props.plan1Yearly1 ?? (
                      <fragment>
                        <span className="pricing14-text079 thq-body-large">
                          or $20 monthly
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  <span>
                    {props.plan31 ?? (
                      <fragment>
                        <span className="pricing14-text099 thq-body-large">
                          Enterprise plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <fragment>
                        <span className="pricing14-text095 thq-heading-3">
                          $2999/year
                        </span>
                      </fragment>
                    )}
